      ...
      child: Column(
        ...
        children: [
          Expanded(
            child: Row(
              children: [
                Icon(Icons.account_balance_wallet, color: color_accent, size: 30).paddingOnly(top: 8, left: 8),
          ...
          Row(
            ...
            children: [
              Text("Номер счета", style: secondaryTextStyle(size: 16)).paddingOnly(left: 8, top: 8, bottom: 8),
              Text(acno, style: primaryTextStyle(color: Colors.black)).paddingOnly(right: 8, top: 8, bottom: 8),
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text("Баланс", style: secondaryTextStyle(size: 16)).paddingOnly(left: 8, top: 8, bottom: 8),
