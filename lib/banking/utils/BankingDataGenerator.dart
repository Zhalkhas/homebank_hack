...
List<BankingPaymentHistoryModel> bankingHistoryList1() {
  ...
  var list1 = BankingPaymentHistoryModel(title: "Payment Invoice # 7783", rs: "-\$200 KZT");
  list.add(list1);

  var list2 = BankingPaymentHistoryModel(title: "Payment Invoice S1244", rs: "-\$190 KZT");
  list.add(list2);
...
List<BankingRateInfoModel> bankingRateInformationList() {
  ...
  var list2 = BankingRateInfoModel(currency: "KZT", flag: Banking_ic_USD, buy: "1,123", sell: "3.85");
  list.add(list2);
  ...
  var list8 = BankingRateInfoModel(currency: "KZT", flag: Banking_ic_USD, buy: "0.1", sell: "1.11");
  list.add(list8);
...
List<BankingHomeModel> bankingHomeList1() {
  ...
  var list1 = BankingHomeModel(title: "Депозитный счет", color: Banking_BalanceColor, bal: "+₸50.000");
  list.add(list1);

  var list2 = BankingHomeModel(title: "Дебетный счет", color: Banking_Primary, bal: "-₸20.000");
  list.add(list2);
